...
public class ExternalSynonymExample1IngestionTest extends IngestionTest<demo.ingest_synonym.external_synonym.example_1.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.external_synonym.example_1.Root> getClazz() {
        return demo.ingest_synonym.external_synonym.example_1.Root.class;
    }
