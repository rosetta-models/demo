...
public class ExternalSynonymExample5IngestionTest extends IngestionTest<demo.ingest_synonym.external_synonym.example_5.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.external_synonym.example_5.Root> getClazz() {
        return demo.ingest_synonym.external_synonym.example_5.Root.class;
    }
