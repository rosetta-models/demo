...
public class MappersExample9IngestionTest extends IngestionTest<demo.ingest_synonym.mappers.example_9.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.mappers.example_9.Root> getClazz() {
        return demo.ingest_synonym.mappers.example_9.Root.class;
    }
