...
public class ConditionalSetExample23IngestionTest extends IngestionTest<demo.ingest_synonym.conditional_set.example_23.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.conditional_set.example_23.Root> getClazz() {
        return demo.ingest_synonym.conditional_set.example_23.Root.class;
    }
