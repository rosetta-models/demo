...
public class SingleCardinalityExample1IngestionTest extends IngestionTest<demo.ingest_synonym.single_cardinality.example_1.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.single_cardinality.example_1.Root> getClazz() {
        return demo.ingest_synonym.single_cardinality.example_1.Root.class;
    }
