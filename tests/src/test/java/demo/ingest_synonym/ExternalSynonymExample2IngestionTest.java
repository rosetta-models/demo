...
public class ExternalSynonymExample2IngestionTest extends IngestionTest<demo.ingest_synonym.external_synonym.example_2.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.external_synonym.example_2.Root> getClazz() {
        return demo.ingest_synonym.external_synonym.example_2.Root.class;
    }
