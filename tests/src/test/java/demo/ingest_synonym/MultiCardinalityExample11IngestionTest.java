...
public class MultiCardinalityExample11IngestionTest extends IngestionTest<demo.ingest_synonym.multi_cardinality.example_11.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.multi_cardinality.example_11.Root> getClazz() {
        return demo.ingest_synonym.multi_cardinality.example_11.Root.class;
    }
