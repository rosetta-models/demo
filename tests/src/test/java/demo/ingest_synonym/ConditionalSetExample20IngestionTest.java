...
public class ConditionalSetExample20IngestionTest extends IngestionTest<demo.ingest_synonym.conditional_set.example_20.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.conditional_set.example_20.Root> getClazz() {
        return demo.ingest_synonym.conditional_set.example_20.Root.class;
    }
