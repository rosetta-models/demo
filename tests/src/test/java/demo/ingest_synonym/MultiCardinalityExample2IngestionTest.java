...
public class MultiCardinalityExample2IngestionTest extends IngestionTest<demo.ingest_synonym.multi_cardinality.example_2.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.multi_cardinality.example_2.Root> getClazz() {
        return demo.ingest_synonym.multi_cardinality.example_2.Root.class;
    }
