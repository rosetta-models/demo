...
public class MetaSchemeExample1IngestionTest extends IngestionTest<demo.ingest_synonym.meta_scheme.example_1.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.meta_scheme.example_1.Root> getClazz() {
        return demo.ingest_synonym.meta_scheme.example_1.Root.class;
    }
