...
public class MetaExternalReferenceExample1IngestionTest extends IngestionTest<demo.ingest_synonym.meta_external_reference.example_1.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.meta_external_reference.example_1.Root> getClazz() {
        return demo.ingest_synonym.meta_external_reference.example_1.Root.class;
    }
