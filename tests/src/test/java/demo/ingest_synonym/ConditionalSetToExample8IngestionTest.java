...
public class ConditionalSetToExample8IngestionTest extends IngestionTest<demo.ingest_synonym.conditional_set_to.example_8.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.conditional_set_to.example_8.Root> getClazz() {
        return demo.ingest_synonym.conditional_set_to.example_8.Root.class;
    }
