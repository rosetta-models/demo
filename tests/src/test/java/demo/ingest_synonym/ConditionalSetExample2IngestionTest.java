...
public class ConditionalSetExample2IngestionTest extends IngestionTest<demo.ingest_synonym.conditional_set.example_2.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.conditional_set.example_2.Root> getClazz() {
        return demo.ingest_synonym.conditional_set.example_2.Root.class;
    }
