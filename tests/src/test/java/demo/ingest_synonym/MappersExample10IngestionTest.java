...
public class MappersExample10IngestionTest extends IngestionTest<demo.ingest_synonym.mappers.example_10.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.mappers.example_10.Root> getClazz() {
        return demo.ingest_synonym.mappers.example_10.Root.class;
    }
