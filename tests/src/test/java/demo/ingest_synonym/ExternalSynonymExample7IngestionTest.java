...
public class ExternalSynonymExample7IngestionTest extends IngestionTest<demo.ingest_synonym.external_synonym.example_7.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.external_synonym.example_7.Root> getClazz() {
        return demo.ingest_synonym.external_synonym.example_7.Root.class;
    }
