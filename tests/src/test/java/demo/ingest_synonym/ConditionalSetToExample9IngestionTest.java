...
public class ConditionalSetToExample9IngestionTest extends IngestionTest<demo.ingest_synonym.conditional_set_to.example_9.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.conditional_set_to.example_9.Root> getClazz() {
        return demo.ingest_synonym.conditional_set_to.example_9.Root.class;
    }
