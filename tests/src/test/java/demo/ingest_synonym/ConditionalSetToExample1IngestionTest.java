...
public class ConditionalSetToExample1IngestionTest extends IngestionTest<demo.ingest_synonym.conditional_set_to.example_1.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.conditional_set_to.example_1.Root> getClazz() {
        return demo.ingest_synonym.conditional_set_to.example_1.Root.class;
    }
