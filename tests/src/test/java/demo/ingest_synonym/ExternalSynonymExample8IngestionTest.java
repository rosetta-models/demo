...
public class ExternalSynonymExample8IngestionTest extends IngestionTest<demo.ingest_synonym.external_synonym.example_8.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.external_synonym.example_8.Root> getClazz() {
        return demo.ingest_synonym.external_synonym.example_8.Root.class;
    }
