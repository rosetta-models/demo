...
public class MetaExternalReferenceExample2IngestionTest extends IngestionTest<demo.ingest_synonym.meta_external_reference.example_2.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.meta_external_reference.example_2.Root> getClazz() {
        return demo.ingest_synonym.meta_external_reference.example_2.Root.class;
    }
