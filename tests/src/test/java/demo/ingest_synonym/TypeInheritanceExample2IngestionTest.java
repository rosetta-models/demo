...
public class TypeInheritanceExample2IngestionTest extends IngestionTest<demo.ingest_synonym.type_inheritance.example_2.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.type_inheritance.example_2.Root> getClazz() {
        return demo.ingest_synonym.type_inheritance.example_2.Root.class;
    }
