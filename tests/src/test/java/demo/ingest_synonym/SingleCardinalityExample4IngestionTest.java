...
public class SingleCardinalityExample4IngestionTest extends IngestionTest<demo.ingest_synonym.single_cardinality.example_4.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.single_cardinality.example_4.Root> getClazz() {
        return demo.ingest_synonym.single_cardinality.example_4.Root.class;
    }
