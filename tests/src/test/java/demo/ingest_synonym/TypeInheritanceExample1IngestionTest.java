...
public class TypeInheritanceExample1IngestionTest extends IngestionTest<demo.ingest_synonym.type_inheritance.example_1.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.type_inheritance.example_1.Root> getClazz() {
        return demo.ingest_synonym.type_inheritance.example_1.Root.class;
    }
