...
public class SingleCardinalityExample6IngestionTest extends IngestionTest<demo.ingest_synonym.single_cardinality.example_6.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.single_cardinality.example_6.Root> getClazz() {
        return demo.ingest_synonym.single_cardinality.example_6.Root.class;
    }
