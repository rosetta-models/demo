...
public class ConditionalSetToExample3IngestionTest extends IngestionTest<demo.ingest_synonym.conditional_set_to.example_3.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.conditional_set_to.example_3.Root> getClazz() {
        return demo.ingest_synonym.conditional_set_to.example_3.Root.class;
    }
