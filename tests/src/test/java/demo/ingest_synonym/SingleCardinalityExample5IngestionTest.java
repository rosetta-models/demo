...
public class SingleCardinalityExample5IngestionTest extends IngestionTest<demo.ingest_synonym.single_cardinality.example_5.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.single_cardinality.example_5.Root> getClazz() {
        return demo.ingest_synonym.single_cardinality.example_5.Root.class;
    }
