...
public class MultiCardinalityExample14IngestionTest extends IngestionTest<demo.ingest_synonym.multi_cardinality.example_14.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.multi_cardinality.example_14.Root> getClazz() {
        return demo.ingest_synonym.multi_cardinality.example_14.Root.class;
    }
