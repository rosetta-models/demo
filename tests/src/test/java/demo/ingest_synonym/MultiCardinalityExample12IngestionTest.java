...
public class MultiCardinalityExample12IngestionTest extends IngestionTest<demo.ingest_synonym.multi_cardinality.example_12.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.multi_cardinality.example_12.Root> getClazz() {
        return demo.ingest_synonym.multi_cardinality.example_12.Root.class;
    }
