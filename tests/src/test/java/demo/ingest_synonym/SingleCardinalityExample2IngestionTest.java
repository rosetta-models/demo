...
public class SingleCardinalityExample2IngestionTest extends IngestionTest<demo.ingest_synonym.single_cardinality.example_2.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.single_cardinality.example_2.Root> getClazz() {
        return demo.ingest_synonym.single_cardinality.example_2.Root.class;
    }
