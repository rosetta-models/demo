...
public class ConditionalSetExample26IngestionTest extends IngestionTest<demo.ingest_synonym.conditional_set.example_26.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.conditional_set.example_26.Root> getClazz() {
        return demo.ingest_synonym.conditional_set.example_26.Root.class;
    }
