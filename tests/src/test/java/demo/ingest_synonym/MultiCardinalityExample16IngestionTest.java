...
public class MultiCardinalityExample16IngestionTest extends IngestionTest<demo.ingest_synonym.multi_cardinality.example_16.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.multi_cardinality.example_16.Root> getClazz() {
        return demo.ingest_synonym.multi_cardinality.example_16.Root.class;
    }
