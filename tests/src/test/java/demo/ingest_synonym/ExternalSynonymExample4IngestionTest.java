...
public class ExternalSynonymExample4IngestionTest extends IngestionTest<demo.ingest_synonym.external_synonym.example_4.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.external_synonym.example_4.Root> getClazz() {
        return demo.ingest_synonym.external_synonym.example_4.Root.class;
    }
