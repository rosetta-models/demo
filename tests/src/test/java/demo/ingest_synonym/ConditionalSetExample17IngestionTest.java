...
public class ConditionalSetExample17IngestionTest extends IngestionTest<demo.ingest_synonym.conditional_set.example_17.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.conditional_set.example_17.Root> getClazz() {
        return demo.ingest_synonym.conditional_set.example_17.Root.class;
    }
