...
public class MetaScopedReferenceExample1IngestionTest extends IngestionTest<demo.ingest_synonym.meta_scoped_reference.example_1.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.meta_scoped_reference.example_1.Root> getClazz() {
        return demo.ingest_synonym.meta_scoped_reference.example_1.Root.class;
    }
