...
public class MultiCardinalityExample18IngestionTest extends IngestionTest<demo.ingest_synonym.multi_cardinality.example_18.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.multi_cardinality.example_18.Root> getClazz() {
        return demo.ingest_synonym.multi_cardinality.example_18.Root.class;
    }
