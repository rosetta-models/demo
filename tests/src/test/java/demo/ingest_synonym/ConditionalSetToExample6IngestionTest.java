...
public class ConditionalSetToExample6IngestionTest extends IngestionTest<demo.ingest_synonym.conditional_set_to.example_6.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.conditional_set_to.example_6.Root> getClazz() {
        return demo.ingest_synonym.conditional_set_to.example_6.Root.class;
    }
