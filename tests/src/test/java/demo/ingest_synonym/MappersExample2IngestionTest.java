...
public class MappersExample2IngestionTest extends IngestionTest<demo.ingest_synonym.mappers.example_2.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.mappers.example_2.Root> getClazz() {
        return demo.ingest_synonym.mappers.example_2.Root.class;
    }
