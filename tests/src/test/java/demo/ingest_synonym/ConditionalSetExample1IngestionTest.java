...
public class ConditionalSetExample1IngestionTest extends IngestionTest<demo.ingest_synonym.conditional_set.example_1.Root> {
    ...
    @Override
    protected Class<demo.ingest_synonym.conditional_set.example_1.Root> getClazz() {
        return demo.ingest_synonym.conditional_set.example_1.Root.class;
    }
